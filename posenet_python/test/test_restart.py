...
def squat_down(ratio, ratio_arr, grad, squat_knee_angle, ready_knee_angle, left_knee_angle, right_knee_angle, left_side_angle, right_side_angle):
    global color
    global test
    squat_side_angle = 90
    ...
    if grad <= -2: # 내려갈 때
        ...
        if ratio < ratio_arr[-2]:
            ...
            if left_knee_angle > squat_knee_angle * 1.2 and right_knee_angle > squat_knee_angle * 1.2: 
                test="Lower"
                color = (0,0,250)
            elif squat_knee_angle <= left_knee_angle < squat_knee_angle * 1.3 and \
                    squat_knee_angle  <= right_knee_angle < squat_knee_angle * 1.3 or \
            ...
            while self.running:
                ...
                if ret:
                    ...
                    if real_start == False:
                        ...
                        squat_down(ratio, ratio_arr, grad, squat_knee_angle, ready_knee_angle, angle_save["L knee"],  angle_save["R knee"], angle_save["L hip"], angle_save["R hip"])
